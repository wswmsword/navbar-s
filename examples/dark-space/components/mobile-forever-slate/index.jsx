...
export default function MobileForeverSlate({ dynamicWidth, t, miniBack, p, head, tail }) {
  const contentItemStyle = {
    width: dynamicWidth ? 320 : "100%",
    flexShrink: 0,
  };
  return <div
    className={styles.wrapper}
    {...p}
    style={{ ...p.style, ...contentItemStyle }}>
    {miniBack}
    <p className={styles.desc}>
    <Trans i18nKey="s_mforever_desc" t={t}><a id="m-first" href="https://github.com/wswmsword/postcss-mobile-forever" ref={miniBack ? null : head}>zero</a>1<a href="https://github.com/wswmsword/scale-view">2</a>3</Trans>
    </p>
    <ul className={styles.links}>
      ...
      <li><a ref={tail} id="m-last" href="https://github.com/wswmsword/postcss-mobile-forever?tab=readme-ov-file#%E8%BE%93%E5%85%A5%E8%BE%93%E5%87%BA%E8%8C%83%E4%BE%8B%E5%92%8C%E5%8E%9F%E7%90%86">{t("s_mf_doc_t6")}</a></li>
    </ul>
  </div>;
}