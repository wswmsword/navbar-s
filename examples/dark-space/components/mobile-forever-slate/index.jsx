...
export default function MobileForeverSlate({ propsFromN, head, tail, dynamicWidth, t, miniBack }) {
  ...
  return <div
    ...
    <p className={styles.desc}>
      <Trans i18nKey="s_mforever_desc" t={t}><a id="m-first" ref={miniBack == null ? head : null} href="https://github.com/wswmsword/postcss-mobile-forever">zero</a>1<a href="https://github.com/wswmsword/scale-view">2</a>3</Trans>
    </p>
    <ul className={styles.links}>
      ...
      <li><a id="m-last" ref={tail} href="https://github.com/wswmsword/postcss-mobile-forever?tab=readme-ov-file#%E8%BE%93%E5%85%A5%E8%BE%93%E5%87%BA%E8%8C%83%E4%BE%8B%E5%92%8C%E5%8E%9F%E7%90%86">{t("s_mf_doc_t6")}</a></li>
    </ul>
  </div>;
}